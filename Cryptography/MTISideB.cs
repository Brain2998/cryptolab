...
{
    public partial class MTISideB : Form
    {
        MTISideA mtia;

        public MTISideB(MTISideA MTIa)
        {
            mtia = MTIa;
            InitializeComponent();
        }
        ...
        public ulong B
        {
            get { return Convert.ToUInt64(this.b.Text); }
            set { this.b.Text = value.ToString(); }
        }
        ...
        public ulong Zb
        {
            get { return Convert.ToUInt64(this.zb.Text); }
            set { this.zb.Text = value.ToString(); }
        }
        ...
        private void calculateSendedMessage_Click(object sender, EventArgs e)
        {
            ...
            Zb = ExpByModule.Exponentiation(A, B, P);
        }

        private void send_Click(object sender, EventArgs e)
        {
            mtia.RecievedMessage = SendedMessage;
            mtia.RecievedZ = Zb;
        }
